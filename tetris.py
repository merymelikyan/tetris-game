...
pygame.display.set_caption("Tetris by Sami Students")
...
while not done:
        ...
        for i in range(4): 
            for j in range(4):
                ...
                if p in game.figure.image():
                    pygame.draw.rect(
                        screen,colors[game.figure.color],
                        [
    ...
    font1 = pygame.font.SysFont("Tahoma", 65, True, False)
